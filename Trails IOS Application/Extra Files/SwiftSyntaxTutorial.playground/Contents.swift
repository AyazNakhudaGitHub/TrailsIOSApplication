//The purpose of this file is to demonstrate the basics of the Swift programming language.

//double slashing for comments 


import Cocoa   // Cocoa is a development API native to the Mac OS X operating system. Cocoa Touch is the closely-related analogous platform for the iOS. It is written in Objective-C, and acts as a sort of “top layer” to each operating system

//import UIKit // this import allows us to develop iOS applications.

import AppKit  // this import allows us to develop MacOS applications.

import Darwin  //imports C libraries


var str: String = "Hello, playground" // var means that this is a variable vlaue that can be changed. if we used let instead of var then we are saying that we are dealing with a constant.


let pi: Double = 3.14159

//println("The value of pi is \(pi)")  --> have to use print instead?

//print("The value of pi is \(pi)")

let numberOfSteps: Int = 500

// Int --> Integers
// Double/ Floats --> floating point numbers or numbers with decimals.
// String --> characters in between double quotation marks.
// Bool --> True or False.
...
let doubleNumber: Double = 14.3
let intNumber: Int = Int(doubleNumber)
print(intNumber)


// % will give you the remainder
print("5.3 % 3 is \(5 % 3)") //--> only works with integers



/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// THIS SECTION CONTAINS ISSUES

//Incrementing and Decrementing
var randomValue: Int = 15

//print("randomValue++ is = \(randomValue++)")  ++ has been removed???
//print("++randomValue is = \(++randomValue)")

// If the operator is before the variable, it increments the variable before returning its value or if the operator is after the variable, it increments the variable after returning its value.

//print("randomValue +=1 is ",randomValue+=1)
print("randomValue is \(randomValue)")
print("randomValue +=1 is",randomValue+=1 , randomValue+3) // notice how th program will not out put anything instead i think it just adds 1
print("randomValue +=1 is \(randomValue)")    // here the program will just print out what we wanted in the line above
print("randomValue +=5 is \(randomValue+=5)")

// this weird case is happening becasue we do +=1 after the random value so, the program will first try to print the value which is the string and the randomValue first then do the arithmetic but the result should have been randomValue +=1 is 15 NOT randomValue +=1 is (). So becasue it tries to print the value of randomValue but since we are changing it it doesn't know whether to print out 15 or 16

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    

//from here on out I am using code from a video about Swift 3
//link to video used : https://www.youtube.com/watch?v=dKaojOZ-az8
